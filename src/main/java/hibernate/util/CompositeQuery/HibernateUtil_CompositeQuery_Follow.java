...
public class HibernateUtil_CompositeQuery_Follow {

	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<FollowVO> root, String columnName, String value) {

		Predicate predicate = null;

		if ("memNoA".equals(columnName) || "memNoB".equals(columnName)) // 用於Integer
	...
	public static List<FollowVO> getAllC(Map<String, String[]> map, Session session) {
...
//		Session session = HibernateUtil.getSessionFactory().openSession();
		...
		try {
			...
			// 【●創建 CriteriaQuery】
			CriteriaQuery<FollowVO> criteriaQuery = builder.createQuery(FollowVO.class);
			// 【●創建 Root】
			Root<FollowVO> root = criteriaQuery.from(FollowVO.class);
			...
			criteriaQuery.orderBy(builder.asc(root.get("actMsgNo")));
