...
public class ActMsgNoController {
	...
	public String getOne_For_Display(
		...
		@RequestParam("actMsgNo") String actMsgNo,
		ModelMap model) {
...
//		EmpService empSvc = new EmpService();
		...
		if (messageVO == null) {
			...
			return "front-end/message/select_page";
		}
...
//		return "front-end/emp/listOneEmp";  // 查詢完成後轉交listOneEmp.html
		return "front-end/message/select_page"; // 查詢完成後轉交select_page.html由其第158行insert listOneEmp.html內的th:fragment="listOneEmp-div
	}
...
//    	EmpService empSvc = new EmpService();
	    ...
	    return new ModelAndView("front-end/message/select_page", "errorMessage", "請修正以下錯誤:<br>"+message);
	}
