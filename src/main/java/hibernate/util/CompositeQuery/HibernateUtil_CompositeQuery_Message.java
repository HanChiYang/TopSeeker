...
public class HibernateUtil_CompositeQuery_Message {

	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<MessageVO> root, String columnName, String value) {

		Predicate predicate = null;

		if ("actMsgNo".equals(columnName)) // 用於Integer
			predicate = builder.equal(root.get(columnName), Integer.valueOf(value));
		else if ("actMsg".equals(columnName)) // 用於varchar
			predicate = builder.like(root.get(columnName), "%" + value + "%");
		else if ("actMsgTime".equals(columnName)) // 用於date
	...
	public static List<MessageVO> getAllC(Map<String, String[]> map, Session session) {
