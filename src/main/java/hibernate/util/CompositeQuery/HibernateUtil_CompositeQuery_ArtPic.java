...
public class HibernateUtil_CompositeQuery_ArtPic {

	public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<ArtPicVO> root, String columnName, String value) {

		Predicate predicate = null;

		if ("artPicNo".equals(columnName)) // 用於Integer
	...
	public static List<ArtPicVO> getAllC(Map<String, String[]> map, Session session) {

//		Session session = HibernateUtil.getSessionFactory().openSession();
		Transaction tx = session.beginTransaction();
		List<ArtPicVO> list = null;
		try {
			// 【●創建 CriteriaBuilder】
			CriteriaBuilder builder = session.getCriteriaBuilder();
			// 【●創建 CriteriaQuery】
			CriteriaQuery<ArtPicVO> criteriaQuery = builder.createQuery(ArtPicVO.class);
			// 【●創建 Root】
			Root<ArtPicVO> root = criteriaQuery.from(ArtPicVO.class);
			...
			criteriaQuery.orderBy(builder.asc(root.get("artPicNo")));
